# Opdracht-Nathan\_Verbeken-Sport\_tracker
...
* belangrijke notities voor tijdens het uitoefenen van de oefening

Bij de Workouts:

* Welke oefening werd uitgevoerd
* het datum dat deze oefening werd uitgevoerd
* hoeveel keer deze werd uitgevoerd
* hoelang deze activiteit heeft geduurd
* notities waarin kan worden vermeld hoe de activiteit is verlopen
...
* een nieuwe oefening toevoegen
* een nieuwe workuout toevoegen
...
Run nu het python bestand \[main.py], er wordt nu een menu getoond dat je toelaat de functies te gebruiken.
